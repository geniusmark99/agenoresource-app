  ...
  <footer class="relative overflow-hidden bg-slate-900 text-white">
    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        ...
        <div>
          <h4 class="text-xs font-semibold text-white uppercase dark:text-gray-100">Product</h4>
  
          <div class="mt-3 grid space-y-3 text-sm">
            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('pricing')}}">Pricing</a></p>
          </div>
        </div>
        <!-- End Col -->
  
        <div>
          <h4 class="text-xs font-semibold text-white uppercase dark:text-gray-100">Company</h4>
  
          <div class="mt-3 grid space-y-3 text-sm">
            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('about')}}">About us</a></p>
            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('blog')}}">Blog</a></p>
            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{ route('contact') }}">Contact</a></p>
          </div>
        </div>
        <!-- End Col -->
        ...
        <div>
          <h4 class="text-xs font-semibold text-white uppercase dark:text-gray-100">Contact us</h4>
  
          <div class="mt-3 grid space-y-3 text-sm">
              <p>
              <a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                hello@agenoresource.com 
              </a> <span class="inline text-gray-800 dark:text-violet-500">— Email us</span>
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
          <div class="flex items-center gap-x-3">
            ...
            <div class="space-x-4 text-sm ms-4">
              <a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('terms')}}">Terms</a>
              <a class="inline-flex gap-x-2 text-white hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('privacy')}}">Privacy</a>
            </div>
          </div>
          ...
          <div class="flex justify-between items-center">
            <div class="mt-3 sm:hidden">
              ...
              <p class="mt-1 text-xs sm:text-sm text-white dark:text-gray-400">© {{date('Y')}} Agenoresources</p>
            </div>

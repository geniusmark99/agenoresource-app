<div class="flex flex-col justify-between gap-y-1 bg-white border border-gray-300/50 rounded-xl dark:bg-gray-800 dark:border-gray-700">
    ...
    <h2 class="text-sm md:text-base lg:text-xl text-gray-800 font-bold dark:text-gray-300">
     Agent: <a class="text-blue-600 underline">Mark David</a>
    </h2>
    </div>
    <!-- End Header -->
    ...
    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit cumque quae omnis ut animi eos, reprehenderit aliquam, magnam saepe molestiae iste repudiandae quas! Modi beatae officia sunt est porro consectetur.
    </p>
    <div class="flex gap-x-3 items-center">
    <h1 class="text-base lg:text-2xl font-bold text-blue-600"><span>For Sales:</span>
    ...
    <a  class="flex gap-x-2 items-center text-white bg-blue-600 rounded-md px-2 py-1 hover:shadow-md transition-all hover:bg-opacity-95">
    ...
    {{-- href="{{ route('assetsmore',[$asset->slug]) }}" --}}
    </div>

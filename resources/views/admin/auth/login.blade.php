...
<section class="w-[270px] md:w-[350px] lg:w-[400px] flex justify-center flex-col gap-y-10">
    <h1 class="text-center text-2xl lg:text-3xl font-bold">Agenoresource Login</h1>

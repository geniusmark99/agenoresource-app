...
<div class="flex flex-col gap-x-4 px-3 md:mt-16 shadow-md  rounded-lg p-2">
  ...
  <a class="w-6/12 md:w-full text-xs sm:text-sm text-center inline-flex items-center justify-center gap-x-2 
  rounded-md bg-green-500 hover:bg-green-600 text-white py-2.5 font-semibold" 
  target="_blank" 

  href="https://wa.me/{{$asset->contact_information}}?text={{ urlencode('Hi my name is ' .  $asset->user->firstname . ' ' .  $asset->user->lastname . ', I would like to buy your asset') }}"
 >
